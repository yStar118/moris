...
<script>
    ...
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${staticServer}/portal/stat/checkPoint/getListForYear.do',//请求数据的参数
    ...
    /*导出*/
    function prints() {
        var url = "${staticServer}/portal/stat/checkPoint/print.do?type=3&index=0&length=99999";
