    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="widget-box" id="widget-box-search" style="margin: 0">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-6 col-lg-5">岗位编号：</label>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="jobs" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th style="background-color: #E5E5E5">岗位编号</th>
    ...
    <div class="modal-dialog" style="width: 50%;top: 18%">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <form id="jobsForm" name="jobsForm" class="form-horizontal"
                              action="${staticServer}/portal/organization/jobs/save.do" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select id="departmentCode" name="departmentCode" class="col-xs-10 col-sm-7"
                                            title="">
                ...
                <div class="widget-box" style="border: none">
                    <div class="widget-body">
                        <div class="widget-main">
                            <c:url value="${staticServer}/portal/organization/jobs/import.do"
                                   var="import_url"/>
...
<script>
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${staticServer}/portal/organization/jobs/getList.do',//请求数据的参数
                    data: jobsParam.getQueryCondition(data),
                    cache: false,  //禁用缓存
                    dataType: "json",
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn  btn-sm btn-info" href="#modal-edit" data-toggle="modal"  data-backdrop="static" ' +
                            'onclick="updateJobs(\'' + data + '\')">' +
                            '<i class="ace-icon fa fa-pencil-square-o "></i>修改</a>' +
                            '&nbsp;&nbsp;' +
                            '<a class="btn btn-sm btn-danger" onclick="delJobs(\'' + data + '\')">' +
    ...
    function flushForm() {
        ...
        $("#jobsForm").find("input").each(function () {
            var id = $(this).attr("id");
            $("#" + id).val("");
        });
        $.ajax({
            type: "get",
            url: "${staticServer}/portal/organization/enterprise/findAll.do",
            contentType: "application/json",
            success: function (data) {
                var vHTML = '';
                if (data.length > 0) {
                    vHTML = ' <option value="">请选择企业</option>';
                    for (var i in data) {
                ...
                $.ajax({
                    type: "get",
                    url: "${staticServer}/portal/organization/department/findAll.do",
                    contentType: "application/json",
                    success: function (data) {
                        var vHTML = '';
                        if (data.length > 0) {
                            vHTML = ' <option value="">请选择部门</option>';
                            for (var i in data) {
                                vHTML += '<option value="' + data[i].code + '">' + data[i].name + '</option>';
                            }
            ...
            success: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "${staticServer}/portal/organization/jobs/findOne.do",
                            data: {
                                "id": id
                            },
                            contentType: 'application/json',
    ...
    /*删除*/
    function delJobs(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该岗位信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${staticServer}/portal/organization/jobs/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
