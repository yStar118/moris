                                ...
                                <div class="widget-main no-padding">
                                    <form:form action="/" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-6 col-lg-5">类别：</label>
                                                    <div class="col-xs-6 col-lg-7">
                                                        <select class="col-xs-12 col-sm-7"
                                                                id="typeSearch">
                                                            <option value="">请选择类别</option>
                                                            <option value="1">检查对象分类</option>
                                                            <option value="2">检查对象属性</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="col-xs-12">
                                <table id="pointTable" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="background-color: #E5E5E5">类别</th>
    ...
    <div class="modal-dialog" style="width: 50%;top: 18%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">编辑方案检索条件</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <form id="pointForm" name="pointForm" class="form-horizontal"
                              action="${staticServer}/portal/dictionary/point/save.do" method="post">
...
<script>
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${staticServer}/portal/dictionary/point/getList.do',//请求数据的参数
    ...
    function updatepoint(id) {
        ...
        $.ajax({
            type: "GET",
            url: "${staticServer}/portal/dictionary/point/findOne.do",
            data: {
                "id": id
            },
    ...
    function delpoint(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该部门信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${staticServer}/portal/dictionary/point/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
