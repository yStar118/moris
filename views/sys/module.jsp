...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs  breadcrumbs-fixed" id="breadcrumbs" style="position: absolute !important;">
                <ul class="breadcrumb">
                                    ...
                                    <table class="searchField" style="margin: 4px; padding: 4px;">
                                        <tr>
                                            <td>
                                                ...
                                                <c:if test="${bln:isP('SysModuleAdd')}">
                            ...
                            <c:forEach items="${list }" var="sysModule" varStatus="st">
                                <tr id="${sysModule.id}" pId="${sysModule.parent_id ne 1?sysModule.parent_id:'0'}">
                                    ...
                                    <td><c:if test="${bln:isP('SysModuleAdd')}">
                                        <a href="toUpdate.do?id=${sysModule.id}&backUrl=${backUrl}"> 修改</i>
                                        </a>
                                    </c:if> <c:if test="${bln:isP('SysModuleDelete')}">
                                        <a href="javascript:delModule(${sysModule.id });"> 删除 </a>
                                    </c:if>
                                        <a href="${dynamicServer }/portal/sys/function/index.do?module_id=${sysModule.id }">功能设置 </a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
