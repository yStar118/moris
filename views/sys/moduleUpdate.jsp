			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div class="page-header">
						<h1>
							模块管理 <small> <i class="ace-icon fa fa-angle-double-right"></i> 修改模块
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div class="row">
						<div class="col-xs-12">
							<form id="moduleForm" name="moduleForm" class="form-horizontal" action="update.do?id=${sysModule.id }" method="post">
								<input type="hidden" name="backUrl" value="${backUrl }">
								<div class="form-group">
									<label class="col-sm-3 control-label">模块名称：</label>
									<div class="col-sm-9">
										<input id="name" name="name" type="text" class="col-xs-10 col-sm-5" placeholder="" value="${sysModule.name }"> <label
											id="nameTip"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input id="parent_id" type="text" name="parent_id"  class="col-xs-10 col-sm-5" placeholder=""
											value="${sysModule.parent_id }"> <span class="input-group-btn">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input id="code" type="text" name="code" class="col-xs-10 col-sm-5" placeholder="" value="${sysModule.code }"><label
											id="codeTip"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input id="url" type="text" name="url" class="col-xs-10 col-sm-5" placeholder="" value="${sysModule.url }"><label
											id="urlTip"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9 ">
										<select name="target" class="col-xs-10 col-sm-5">
											<option value="main" <c:if test="${sysModule.target eq 'main'} "> selected</c:if>>main</option>
											<option value="blank" <c:if test="${sysModule.target eq 'blank'} "> selected</c:if>>blank</option>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input id="iconImg" type="text" name="iconImg" class="col-xs-10 col-sm-5" placeholder="" value="${sysModule.iconImg }"><label
											id="iconImgTip"></label>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input id="display_order" type="text" name="display_order" class="col-xs-10 col-sm-5" placeholder=""
											value="${sysModule.display_order }"><label id="display_orderTip"></label>
									</div>
								</div>
