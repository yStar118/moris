            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="project" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th style="background-color: #E5E5E5">计划名称</th>
...
<script>
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${staticServer}/portal/inspection/project/getList.do',//请求数据的参数
                    data: projectParam.getQueryCondition(data),
                    cache: false,  //禁用缓存
                    dataType: "json",
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn btn-sm btn-danger" onclick="delProject(\'' + data + '\')">' +
    ...
    function detailProject(id) {
        window.location.href = "${staticServer}/portal/inspection/project/detail.do?id=" + id;
    }

    /*删除*/
    function delProject(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该检查计划吗？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${staticServer}/portal/inspection/project/delete.do",
                    data: {
                        "id": id
                    },
