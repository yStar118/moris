                            ...
                            <div class="col-xs-12">
                                <table id="task" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="background-color: #E5E5E5">检查点异常数量</th>
...
<script>
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${staticServer}/portal/inspection/task/getResultList.do',//请求数据的参数
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn  btn-sm btn-info" onclick="detailTask(\'' + row.type + '\',\'' + row.id + '\')">' +
                            '<i class="ace-icon fa fa-pencil-square-o "></i>详情信息</a>' +
                            '&nbsp;&nbsp;';
                    }
                }
            ],
    ...
    /*详情*/
    function detailTask(type, taskId) {
        window.location.href = "${staticServer}/portal/inspection/taskSub/index.do?type=" + type + "&taskId=" + taskId;
    }
