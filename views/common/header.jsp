...
<link rel="stylesheet"
      href="${staticServer }/assets/components/font-awesome/css/font-awesome.css?versionNo=${versionNo}"/>
<!-- page specific plugin styles -->
<!-- text fonts -->

<link rel="stylesheet" href="${staticServer }/assets/css/common.css?versionNo=${versionNo}"/>
<link rel="stylesheet"
      href="${staticServer }/assets/dataTables/css/jquery.dataTables.fixedColums.css?versionNo=${versionNo}"/>
<link rel="stylesheet" href="${staticServer }/assets/dataTables/css/jquery.dataTables.css?versionNo=${versionNo}"/>
...
<link rel="shortcut icon" href="${staticServer }/assets/images/favicon.ico"
      mce_href="${staticServer }/assets/images/favicon.ico" type="image/x-icon"/>
